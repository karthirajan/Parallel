...
public class ColorSpecificationTK extends Commonactions {
    ...
    public void userCreatesTheCanvasTemplate(String a, String b) throws Throwable {
        ...
        for (int i = 0; i < template.length; i++) {
            ...
            ca.click(sp.getPopUpSaveBtn());
            Thread.sleep(3000);
            WebElement canvasTemplate = driver.findElement(By.xpath("(//a[@class='browse' and text()='" + template[i] + "']//following::td[@data-csi-heading='Active::0'])[1]"));
            waitForElementClickable(canvasTemplate);
    ...
    public void userNavigatesToLibrariesTab() throws Throwable {
        Commonactions.navigateToTab(spec.getSpecificationTab(),shp.getCareLabelLibrariesTab(),lp.getRightArrowBtn());
    }
    ...
    public void userCreatesTheSizeChartCanvas(String a) throws Throwable {
        ...
        for (int i = 0; i <SizeChartName.length ; i++) {
            ...
            ca.click(sp.getPopUpSaveBtn());
            Thread.sleep(2500);
            WebElement datasheet = driver.findElement(By.xpath("(//a[@class='browse' and text()='" + SizeChartName[i] + "']//following::td[@data-csi-act='SizeRange:Child:CurrentRevision:0'])[1]"));
            Thread.sleep(2500);
    ...
    public void userCreatesTheDimensionInsideTheCanvas(String a) throws Throwable {
        ...
        driver.navigate().refresh();
        Commonactions.jsWaitForPageLoad();
        WebElement size = driver.findElement(By.xpath("(//td[@data-csi-act='BaseSize::0'])[1]"));
    ...
    public void userCreatesTheDataForTheColorLibraries(String a) throws Throwable {
        Commonactions.navigateToTab(spec.getSpecificationTab(),shp.getColorLabelLibrariesTab(),lp.getRightArrowBtn());
        Actions actions = new Actions(driver);
