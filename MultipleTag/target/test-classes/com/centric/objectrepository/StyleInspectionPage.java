...
public class StyleInspectionPage extends Commonactions{
	...
	@FindBy(xpath="(//span[contains(@data-csi-automation,'ProductBOMRevision-PartMaterials-CustomViewActions')]//span[text()='Views'])[2]")
	private WebElement BomViews2;

	@FindBy(xpath="(//tr[contains(@data-csi-automation,'ProductBOMRevision-PartMaterials-CustomViewManage')]//td[text()='Manage Views'])[2]")
	...
	@FindBy(xpath="(//span[@data-csi-automation='plugin-SizeChartRevision-Dimensions-CustomViewActions']//following::span[contains(@data-csi-automation,'SizeChartRevision')]//span[text()='Views'])[2]")
	private WebElement DimensionView;

	@FindBy(xpath="(//tr[@data-csi-automation='plugin-SizeChartRevision-Dimensions-CustomViewManage']//following::tr[contains(@data-csi-automation,'SizeChartRevision')]//td[text()='Manage Views'])[2]")
