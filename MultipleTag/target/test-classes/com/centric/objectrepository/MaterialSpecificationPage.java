...
public class MaterialSpecificationPage extends Commonactions{
	...
	@FindBy(xpath="//span[contains(@data-csi-tab,'SizeChartAdmin-CareSymbols') and text()='Care Labels']")
	...
	@FindBy(xpath="//span[contains(@data-csi-tab,'SizeChartAdmin-Language') and text()='Languages']")
	...
	@FindBy(xpath="//span[contains(@data-csi-tab,'ApparelViews-ProductStructure') and text()='Product Structures']")
